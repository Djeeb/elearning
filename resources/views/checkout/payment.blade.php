        ...
        <div class="col-lg-8">
            ...
            <div class="order-details my-5">
                ...
                <table class="table table-striped">
                    <tbody>
                        @php
                        $tax = \Cart::session(Auth::user()->id)->getTotal() / 5.1;
...
var stripe = Stripe('pk_test_51ICkdhKSBKpfIXPV9qby88klN0IcBBDOlmCQNjxVSSgVGuokfvoq83j7ncHx2LwIbqOXhvY008VmV9wcKEjlSDfe00BfTG2O4l');
